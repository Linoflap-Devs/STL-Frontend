    ...
    [
      {
        ...
        approvedAreaOfOperations: "Marikina City, Mandaluyong City, San Juan City",
      ...
      if (searchQuery) {
        ...
        const filtered = transactions.filter(
          (transaction) =>
            ...
            transaction.approvedAreaOfOperations.toLowerCase().includes(lowercasedQuery) ||
            transaction.dateOfOperations.toLowerCase().includes(lowercasedQuery) ||
      ...
      <TableHead>
        <TableRow>
          {[
            ...
            { label: "Approved Area of Operations", key: "approvedAreaOfOperations" },
                ...
                <TableCell>
                  <Button
                    ...
                    sx={{
                      ...
                      fontSize: "14px",
                      backgroundColor:
                        operator.status === "Inactive" ? "#FF7A7A" : "#4CAF50",
                      color: "#171717",
                      "&:hover": {
                        backgroundColor:
                          operator.status === "Inactive" ? "#F05252" : "#4CAF50",
                      },
                    }}
                  >
                    {operator.status}
