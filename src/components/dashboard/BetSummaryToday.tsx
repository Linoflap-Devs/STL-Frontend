    ...
    return (
        <Box sx={{ marginTop: "2rem" }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                <Typography sx={{ color: "#E3C9FF", fontWeight: 700, marginBottom: "1rem" }} variant="h6">
                    Bet Summary Today
                </Typography>
                <Box>
                    <Button
                        sx={{
                            fontSize: '12px', textAlign: "left", color: '#3F3F3F', textTransform: 'none', backgroundColor: "#CCA1FD", mb: 0.7, paddingX: 3, paddingY: 0.9, width: 'auto', "&:hover": {
            ...
            <Box sx={{ display: 'flex', }}>
                <Box sx={{ backgroundColor: "#383838", padding: "1rem", paddingBottom: '0px', borderRadius: "8px", maxWidth: '50%', }}>
                    <Box sx={{ marginBottom: '-30px' }}>
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 1, mt: 1 }}>
                            <Box>
                                ...
                                <Typography color="#FFFFFF" sx={{ fontSize: "24px", lineHeight: 1.2, fontWeight: "700", color: '#D4AEFE', }}>
                    ...
                    <BarChart
                        ...
                        width={600}
                        height={260}
                        series={[{ data: data.map(item => item.amount), color: "#D4AEFE" }]}
                        xAxis={[
                            {
                                scaleType: "linear",
                                min: 0,
